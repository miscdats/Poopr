...
<script>
  ...
  const ignore = ['answers','totalScore','geohash','seek','geoJson','hashKey','created','rangeKey','type','state','author']
  ...
  export default {
    ...
    methods: {
      async loadAnswers() {
        ...
        const url = `${this.$APIurl}/geoSeek?hk=${this.hk}&rk=${this.rk}`
        ...
        const seekLoc = (JSON.parse(data.geoJson.S)).coordinates
        this.currentLng = seekLoc[0]
        this.currentLat = seekLoc[1]
